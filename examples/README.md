...
This directory contains examples to help you understand what `austimes-tables` produces and how to use it.
...
Generated by running `austimes-tables extract` on the sample deck. This shows:
...
austimes-tables extract /path/to/your/deck
```
...
austimes-tables format examples/sample_deck
```
...
austimes-tables validate deck/  # Exit code 1 if errors
